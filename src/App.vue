...
/* eslint-disable vue/no-unused-components */ //removes the error,of registered but not used components
...
export default {
  ...
  data: () => ({
    ...
    {icon:'mdi-magnify',text:'Search',route:'/research'}
...
<style>
  ...
  ::-webkit-scrollbar-track{
    -webit-box-shadow: inset 0 0 6px black rgba(0,0,0,0.3);
    border-radius: 10px;
  }
